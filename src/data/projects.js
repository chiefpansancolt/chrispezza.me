    ...
    description: `
      ...
      <div>
        ...
        <ul class="divide-y divide-slate-200">
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Risk Rating Review Selector</p>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Accelerator Admin Dashboard</p>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Validation Rules Engine</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
                <span class="flex-shrink-0 whitespace-nowrap text-sm text-slate-500">2016</span>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">nCino Overview</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
                <span class="flex-shrink-0 whitespace-nowrap text-sm text-slate-500">2016</span>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Covenant/Collateral UI Editors</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
                <span class="flex-shrink-0 whitespace-nowrap text-sm text-slate-500">2016</span>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Products & Services View</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
                <span class="flex-shrink-0 whitespace-nowrap text-sm text-slate-500">2015</span>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">Fee Management</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
                <span class="flex-shrink-0 whitespace-nowrap text-sm text-slate-500">2015</span>
          ...
          <li class="relative bg-white py-5 px-4 hover:bg-slate-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
            <div class="flex justify-between space-x-3">
                <div class="min-w-0 flex-1">
                  <div class="block focus:outline-none">
                      <span class="absolute inset-0" aria-hidden="true"></span>
                      <p class="text-sm font-medium text-slate-900">LookupKey Generator</p>
                      <p class="text-sm text-slate-500">nCino Accelerator (Deprecated)</p>
                  </div>
                </div>
