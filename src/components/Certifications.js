      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="flex justify-center mb-10 lg:mb-0">
          <h4 className="text-xl">
            <Link
              ...
              className="border-solid border-b-4 border-blue-500 uppercase tracking-widest font-bold cursor-pointer"
            >
        ...
        <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-4 lg:mt-8">
          {salesforceCertifications.map((cert) => (
            <div key={cert.name} className="col-span-1 flex justify-center py-8 px-8 bg-slate-100">
              <Link href={cert.href}>
